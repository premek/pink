...
return function (globalTree)
        ...
        local rootEnv = {
            ...
            MIN={'native', min},
            MAX={'native', max},
            LIST_VALUE={'native', list.value},
            LIST_COUNT={'native', list.count},
            LIST_RANDOM={'native', list.random},
            LIST_ALL={'native', list.all},
            LIST_MIN={'native', list.min},
            LIST_MAX={'native', list.max},
            LIST_INVERT={'native', list.invert},
            LIST_RANGE={'native', list.range},
            ['^']={'native', list.intersection},
        }
